...
YELP_CLIENT_ID = getattr(settings, 'YELP_CLIENT_ID','LyrGVZDbfioZlAYcTRDgrg')
YELP_CLIENT_SECRET = getattr(settings, 'YELP_CLIENT_SECRET','kxqzG5NI885CDzWNKH7fRXs7ae32eGrwguKGGSLDoqHXItO17fdWbtyR6GliJRXX')
...
def yelp_search(keyword='Food', location='Edmonton', request=None):
